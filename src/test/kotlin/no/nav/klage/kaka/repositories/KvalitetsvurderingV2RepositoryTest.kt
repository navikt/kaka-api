...
@DataJpaTest
class KvalitetsvurderingV2RepositoryTest : PostgresIntegrationTestBase() {
    @Autowired
    ...
    fun `add kvalitetsvurderingV2 with complete valueset`() {
        ...
        assertThat(
            foundKvalitetsvurderingV2.klageforberedelsenSakensDokumenter,
        ).isEqualTo(kvalitetsvurderingV2.klageforberedelsenSakensDokumenter)
        assertThat(
            foundKvalitetsvurderingV2.klageforberedelsenSakensDokumenterRelevanteOpplysningerFraAndreFagsystemerErIkkeJournalfoert,
        ).isEqualTo(
        ...
        assertThat(
            foundKvalitetsvurderingV2.klageforberedelsenFeilVedBegrunnelsenForHvorforAvslagOpprettholdesKlagerIkkeOppfyllerVilkaar,
        ).isEqualTo(
        ...
        assertThat(
            foundKvalitetsvurderingV2.utredningenAvEoesUtenlandsproblematikk,
        ).isEqualTo(kvalitetsvurderingV2.utredningenAvEoesUtenlandsproblematikk)
        assertThat(
            foundKvalitetsvurderingV2.utredningenAvAndreAktuelleForholdISaken,
        ).isEqualTo(kvalitetsvurderingV2.utredningenAvAndreAktuelleForholdISaken)
        assertThat(
            foundKvalitetsvurderingV2.vedtaketLovbestemmelsenTolketFeil,
        ).isEqualTo(kvalitetsvurderingV2.vedtaketLovbestemmelsenTolketFeil)
        ...
        assertThat(
            foundKvalitetsvurderingV2.vedtaketFeilKonkretRettsanvendelse,
        ).isEqualTo(kvalitetsvurderingV2.vedtaketFeilKonkretRettsanvendelse)
        ...
        assertThat(
            foundKvalitetsvurderingV2.vedtaketIkkeKonkretIndividuellBegrunnelse,
        ).isEqualTo(kvalitetsvurderingV2.vedtaketIkkeKonkretIndividuellBegrunnelse)
        ...
        assertThat(
            foundKvalitetsvurderingV2.vedtaketIkkeKonkretIndividuellBegrunnelseIkkeGodtNokFremHvordanRettsregelenErAnvendtPaaFaktum,
        ).isEqualTo(
        ...
        assertThat(
            foundKvalitetsvurderingV2.vedtaketDetErLagtTilGrunnFeilFaktum,
        ).isEqualTo(kvalitetsvurderingV2.vedtaketDetErLagtTilGrunnFeilFaktum)
        assertThat(
            foundKvalitetsvurderingV2.vedtaketSpraakOgFormidlingErIkkeTydelig,
        ).isEqualTo(kvalitetsvurderingV2.vedtaketSpraakOgFormidlingErIkkeTydelig)
