...
class KvalitetsvurderingV3RepositoryTest : PostgresIntegrationTestBase() {
    ...
    fun `add kvalitetsvurderingV3 with all values and verify`() {
        ...
        assertThat(
            foundKvalitetsvurderingV3.saerregelverkLovenErTolketEllerAnvendtFeil,
        ).isEqualTo(kvalitetsvurderingV3.saerregelverkLovenErTolketEllerAnvendtFeil)
        ...
        assertThat(
            foundKvalitetsvurderingV3.saerregelverkDetErLagtTilGrunnFeilFaktum,
        ).isEqualTo(kvalitetsvurderingV3.saerregelverkDetErLagtTilGrunnFeilFaktum)
        ...
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerUtredningspliktenUtredningenAvMedisinskeForholdHarIkkeVaertGodNok,
        ).isEqualTo(
            kvalitetsvurderingV3.saksbehandlingsreglerUtredningspliktenUtredningenAvMedisinskeForholdHarIkkeVaertGodNok,
        )
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerUtredningspliktenUtredningenAvInntektsArbeidsforholdHarIkkeVaertGodNok,
        ).isEqualTo(
            kvalitetsvurderingV3.saksbehandlingsreglerUtredningspliktenUtredningenAvInntektsArbeidsforholdHarIkkeVaertGodNok,
        )
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerUtredningspliktenUtredningenAvEoesUtenlandsforholdHarIkkeVaertGodNok,
        ).isEqualTo(
            kvalitetsvurderingV3.saksbehandlingsreglerUtredningspliktenUtredningenAvEoesUtenlandsforholdHarIkkeVaertGodNok,
        )
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerUtredningspliktenUtredningenAvSivilstandsBoforholdHarIkkeVaertGodNok,
        ).isEqualTo(
            kvalitetsvurderingV3.saksbehandlingsreglerUtredningspliktenUtredningenAvSivilstandsBoforholdHarIkkeVaertGodNok,
        )
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerUtredningspliktenUtredningenAvSamvaersforholdHarIkkeVaertGodNok,
        ).isEqualTo(
            kvalitetsvurderingV3.saksbehandlingsreglerUtredningspliktenUtredningenAvSamvaersforholdHarIkkeVaertGodNok,
        )
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerUtredningspliktenUtredningenAvAndreForholdISakenHarIkkeVaertGodNok,
        ).isEqualTo(
        ...
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerForeleggelsespliktenUttalelseFraRaadgivendeLegeHarIkkeVaertForelagtParten,
        ).isEqualTo(
            kvalitetsvurderingV3.saksbehandlingsreglerForeleggelsespliktenUttalelseFraRaadgivendeLegeHarIkkeVaertForelagtParten,
        )
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerForeleggelsespliktenAndreOpplysningerISakenHarIkkeVaertForelagtParten,
        ).isEqualTo(
        ...
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerBegrunnelsespliktenBegrunnelsenViserIkkeTilRegelverketHjemlerList,
        ).isEqualTo(
        ...
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerBegrunnelsespliktenBegrunnelsenNevnerIkkeAvgjoerendeHensynHjemlerList,
        ).isEqualTo(
        ...
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerBruddPaaKlageKlagefristenEllerOppreisningErIkkeVurdertEllerFeilVurdert,
        ).isEqualTo(
            kvalitetsvurderingV3.saksbehandlingsreglerBruddPaaKlageKlagefristenEllerOppreisningErIkkeVurdertEllerFeilVurdert,
        )
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerBruddPaaKlageDetErIkkeSoergetForRettingAvFeilIKlagensFormEllerInnhold,
        ).isEqualTo(
            kvalitetsvurderingV3.saksbehandlingsreglerBruddPaaKlageDetErIkkeSoergetForRettingAvFeilIKlagensFormEllerInnhold,
        )
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerBruddPaaKlageUnderKlageforberedelsenErDetIkkeUtredetEllerGjortUndersoekelser,
        ).isEqualTo(
        ...
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerBruddPaaKlageAlleRelevanteDokumenterIkkeOversendtKlageinstansen,
        ).isEqualTo(
        ...
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerOmgjoeringDetErFattetVedtakTilTrossForAtBeslutningVarRiktigAvgjoerelsesform,
        ).isEqualTo(
        ...
        assertThat(
            foundKvalitetsvurderingV3.saksbehandlingsreglerJournalfoeringspliktenRelevanteOpplysningerHarIkkeGodNokTittelEllerDokumentkvalitet,
        ).isEqualTo(
