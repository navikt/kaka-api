...
import no.nav.klage.kaka.domain.kodeverk.Role.KAKA_ADMIN
...
import no.nav.klage.kaka.domain.kodeverk.Role.KAKA_TOTALSTATISTIKK
...
fun isAllowedToReadKvalitetstilbakemeldinger(roller: Set<Role>): Boolean = KAKA_KVALITETSTILBAKEMELDINGER in roller
