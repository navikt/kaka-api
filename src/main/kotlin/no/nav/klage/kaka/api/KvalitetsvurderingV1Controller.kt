...
class KvalitetsvurderingV1Controller(
    ...
    fun patchKvalitetsvurdering(
        ...
        @RequestBody
        data: JsonNode,
    ): KvalitetsvurderingV1 = kvalitetsvurderingV1Service.patchKvalitetsvurdering(kvalitetsvurderingId = kvalitetsvurderingId, input = data)
    ...
    fun getKvalitetsvurdering(
        ...
        logKvalitetsvurderingMethodDetails(
            methodName = ::getKvalitetsvurdering.name,
