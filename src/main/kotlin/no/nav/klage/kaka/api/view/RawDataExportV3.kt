...
data class AnonymizedFinishedVurderingV3(
    ...
    var saksbehandlingsreglerBruddPaaRegleneOmForhaandsvarsling: Boolean,
    var saksbehandlingsreglerForhaandsvarslingPartenIkkeVarsletFoerVedtak: Boolean,
    var saksbehandlingsreglerForhaandsvarslingPartenVarsletMangelfullt: Boolean,
    ...
    var saksbehandlingsreglerBruddPaaKlageRegleneIkkeFulgtTilTrossForNyttEnkeltvedtak: Boolean,
    var saksbehandlingsreglerBruddPaaKlageAlleRelevanteDokumenterIkkeOversendtKlageinstansen: Boolean,
