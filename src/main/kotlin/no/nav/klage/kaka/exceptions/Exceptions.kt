...
class KvalitetsvurderingNotFoundException(
    msg: String,
) : RuntimeException(msg)

class SaksdataNotFoundException(
    msg: String,
) : RuntimeException(msg)
...
class KvalitetsvurderingFinalizedException(
    msg: String,
) : RuntimeException(msg)

class SaksdataFinalizedException(
    msg: String,
) : RuntimeException(msg)

class InvalidSakenGjelderException(
    msg: String,
) : RuntimeException(msg)
